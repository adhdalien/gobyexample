// cmd/rangeoverchannels/main.go
package main

import "fmt"

// Previously we saw how for and range provide iteration over basic data
// structures. We can also use this syntax to iterate over values received
// from a channel.
