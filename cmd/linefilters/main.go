...
// processes it, and then prints some derived result to stdout. grep and sed are
// common line filters.

// Here's an example of a line filter in Go that writes a capitalized version of
// all input text. You can use this pattern to write your own Go line filters.
...
func main() {
	...
	// Check for errors during Scan. End of file expected and not reported by
	// Scan as an error.
