...
// intSeq returns another function, which we define anonymously in the body of
...
func main() {
	// We call intSeq, assigning the result (a function) to nextInt. This func
	// value captures its own i value, which will be updated each time we call
	// nextInt.
	nextInt := intSeq()
