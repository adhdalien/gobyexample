...
func main() {
	...
	// For example, this prints an intance of our point struct.
	p := point{1, 2}
	...
	// source snippet that would produce that value.
	...
	// This prints a character corresponding to the given integer.
	fmt.Printf("char: %c\n", 33)
