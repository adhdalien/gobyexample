...
func main() {
	...
	// now. Wait for them to finish (for a better approach, use a WaitGroup).
	...
	// interleaved, because goroutines are being run concurrently by the Go
	// runtime.
}
