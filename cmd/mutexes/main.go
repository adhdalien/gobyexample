...
// Simple counter state management can be done using atomic operators. For more
// complex state we can use a mutex to safely access data across multiple
// goroutines.
...
func main() {
	...
	// Show that the counters updated as expected.
