// cmd/stringfunctions/main.go
package main

// The standard library’s strings package provides many useful string-related functions. Here are some examples to give
// you a sense of the package.
