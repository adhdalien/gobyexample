...
// Ruby and the overloaded single result / error value sometimes used in C. Go’s
// approach makes it easy to see which functions return errors and to handle
// them using the same language constructs employed for any other, non-error
// tasks.

// By convention, errors are the last return value and have type error, a built-
// in interface.
...
// to explictly represent an argument error.
...
func main() {
	...
	// A great post on the Go blog for more on error handling:
