...
func main() {
	...
	// use the builtin make function. Here we make a slice of strings of length
	...
	// This slices up to (but not including) s[5]
	l = s[:5]
	fmt.Println("sl2:", l)
	...
	// We can declare and initialize a variable for slice in a single line also.
	t := []string{"g", "h", "i"}
	fmt.Println("dcl:", t)
